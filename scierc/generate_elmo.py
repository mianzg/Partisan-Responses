...
#### Model #####
parser = argparse.ArgumentParser(description='Elmo generation')
parser.add_argument("-fn",default= './data/scierc/train.json', 
                    help="Input file to generate elmo embeddings")
parser.add_argument("-outfn",default= './data/scierc/train.hdf5', 
